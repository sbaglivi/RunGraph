...
def plan_accepted(state: models.State):
...
def build_graph():
    ...
    agent_builder.add_node("get_plan_feedback", nodes.get_plan_feedback)
    agent_builder.add_node("workout_planner", nodes.workout_planner)
    ...
    agent_builder.add_edge("planner_node", "get_plan_feedback")
    agent_builder.add_edge("workout_planner", END)
